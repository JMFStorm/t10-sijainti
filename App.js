...
export default function App() {
  ...
  const [markerName, setMarkerName] = useState("User");
  ...
  useEffect(
    () =>
      (async () => {
        ...
        setMarkerCoordinate(userCoords);
        setMarkerName("User");
  ...
  }, [fetchLocation, setMarkerCoordinate, setMarkerName, keyword]);

  return (
    <View style={styles.container}>
      <MapView ref={mapRef} style={styles.map} initialRegion={mapInitial}>
        <Marker coordinate={markerCoordinate} title={markerName} />
      </MapView>
      <View>
        <TextInput
          style={styles.input}
